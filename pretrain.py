...
def main(args):
    ...
    for s in range(start_step, STEPS):
        ...
        if s % args.save_inter == 0:
            utils.save_checkpoint(s, net, './s-bs64-7', args.model_name)
        print('debug')
    ...
    plt.plot(x, loss_all, 'c-', label="Loss")
    plt.xlabel('Epochs')
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig('./tb/s-bs64-7.jpg')
    plt.show()
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--steps', default=30001, type=int, help='How many episodes')
    ...
    argparser.add_argument('--csv_path', help='file list of meta-test dataset', default='./data/kadid10k/25_types_csv')
    argparser.add_argument('--dataset_path', help='Path to dataset', default='/home/weilongsheng/Workspace_qq/datasets/kadid10k/images')
    argparser.add_argument('--print_inter', default=100, type=int, help='How many steps to print info')
    argparser.add_argument('--eval_inter', default=30001, type=int, help='How many steps to evalaute model')
