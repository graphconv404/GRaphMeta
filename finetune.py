...
def main(args):
    ...
    folder_path = {
        'live': '/home/weilongsheng/Workspace_qq/datasets/LIVE/databaserelease2',
        'csiq': 'F:/BaiduNetdiskDownload/CSIQ',
        'tid2013': './data/TID2013',
        'livec': 'F:/BaiduNetdiskDownload/LIVE_WILD/ChallengeDB_release',
        'koniq': './data/KonIQ',
        'bid': './data/BID',
        'kadid-F': 'F:/BaiduNetdiskDownload/kadid10k'
    }
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--model_name', help='Name of model to be saved', default='live')
    argparser.add_argument("--tb", action="store_true", default=False)
    argparser.add_argument('--restore', help='Use a checkpoint model', action='store_true', default=True)
    argparser.add_argument('--restore_epoch', type=int, help='restorefrom which epoch', default=1)
    argparser.add_argument('--ckpt', help='Path to checkpoint', default='./s-bs64-7/Pretrain-model/Pretrain-model_step_10000.pth')
    argparser.add_argument('--gpus', default=1, type=int, help='number of gpu')
    argparser.add_argument('--gpu_id', type=str, default='0', help='GPU ID')
    ...
    argparser.add_argument('--bs', default=64, type=int, help='How many episodes to update policy')
